			...
			if("shop")
				...
				if(href_list["KarmaBuy2"])
					...
					switch(href_list["KarmaBuy2"])
						if("1")
							karma_purchase(karma,15,"species","Machine People","КПБ")
						if("2")
							karma_purchase(karma,30,"species","Кидан")
						if("3")
							karma_purchase(karma,30,"species","Серый")
						if("4")
							karma_purchase(karma,45,"species","Вокс")
						if("5")
							karma_purchase(karma,45,"species","Слаймомен")
						if("6")
							karma_purchase(karma,45,"species","Плазмомен")
						if("7")
							karma_purchase(karma,30,"species","Драск")
					return
