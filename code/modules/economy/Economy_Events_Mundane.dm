	...
	if(!newMsg.body)
		...
		switch(event_type)
			...
			if(SONG_DEBUT)
				...
				[pick("roses","three stars","starships","nanobots","cyborgs","Скрелл","Sren'darr")] \
			...
			if(MOVIE_RELEASE)
				...
				[pick("Deadly","The last","Lost","Dead")] [pick("Starships","Warriors","outcasts","Tajarans","Унати","Скрелл")] \
